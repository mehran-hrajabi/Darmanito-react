    ...
    return (
        ...
        <div className="service_body">
            <div className="service_items">
                <div>
                    <div className="service_items_container" id="active">
            ...
            <div className="service_description">
                ...
                <div className="service_steps">
                    ...
                    <p className="step_title">قدم اول</p>
                    <p className="step_description">وارد بخش سفارش با عکس نسخه شوید و عکس و توضیحات را وارد کنید.</p>

                    <img id="step2" src={arrow} />
                    <p className="step_title">قدم دوم</p>
                    <p className="step_description">بعد از ارسال عکس نسخه، باید آدرس محل خودتون رو وارد کنید.</p>

                    <img id="step3" src={done} />
                    <p className="step_title">قدم سوم</p>
                    <p className="step_description">اگر نتیجه جستجوی نسخه موفقیت آمیز باشه باید منتظر تحویل سفارش باشید.</p>
                </div>
            </div>
        </div>
    </div>
